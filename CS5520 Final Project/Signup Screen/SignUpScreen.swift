...
class SignUpScreen: UIView {
    ...
    let usernameTextField: UITextField = createTextField(withPlaceholder: "UserName", iconName: "person")
    ...
    func setupAutoLayout() {
        let stackView = UIStackView(arrangedSubviews: [titleLabel, subtitleLabel, usernameTextField, emailTextField, passwordTextField, signUpButton, loginButton])
        ...
        [usernameTextField, emailTextField, passwordTextField].forEach { textField in
